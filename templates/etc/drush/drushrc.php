...
$options['result-file'] = '/tmp/db_export.sql';
 ...
 */
 $options['structure-tables']['common'] = array('cache', 'cache_filter', 'cache_menu', 'cache_page', 'history', 'sessions', 'watchdog', 'access', 'accesslog');
 $options['structure-tables']['extra'] = array('url_alias', 'path_redirect', 'media_mover_files');
